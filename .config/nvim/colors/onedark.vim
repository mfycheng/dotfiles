...
" Slight modification here to use the black from Tomorrow Night
let s:black = { "gui": "#1D1F21", "cterm": "235", "cterm16": "0" }
...
let s:gutter_bg_grey = { "gui": "#lD1F21", "cterm": "NONE", "cterm16": "NONE" }
